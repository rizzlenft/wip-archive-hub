...
5. **ATTENDEE REWARDS** — "$WIP Token Rewards" section ONLY (no NFT gifts here). Brief text: "Attend our weekly meetups and receive $WIP tokens as a thank you for being part of our community. Every attendee gets rewarded!" Add links to buy/view:
   ...
   Style with accent-border card matching the theme, icon/emoji header ("🪙" for tokens).
